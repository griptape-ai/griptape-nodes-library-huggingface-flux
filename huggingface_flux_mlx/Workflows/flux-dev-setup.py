...
with GriptapeNodes.ContextManager().flow(flow0_name):
    node0_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="HuggingFaceModelDownload",
            specific_library_name="HuggingFace Flux MLX Apple Silicon Library",
            node_name="HuggingFace Model Download",
            metadata={
                "position": {"x": 328.2173274596182, "y": 956.5580029368575},
                "tempId": "placing-1753308111884-cxtl57",
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="HuggingFaceModelDownload",
            specific_library_name="HuggingFace Flux MLX Apple Silicon Library",
            node_name="HuggingFace Model Download_1",
            metadata={
                "position": {"x": -472.72393538913343, "y": 955.9882525697504},
                "tempId": "placing-1753308146161-ngrlw",
                "library_node_metadata": {
                    "category": "Setup",
                    "description": "Download HuggingFace models to local cache with real-time progress tracking and model card information.",
                },
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="repo_id",
                node_name=node0_name,
                value=top_level_unique_values_dict[
                    "9fce04cc-abe2-4fc4-b89c-ed6e08515a45"
                ],
                initial_setup=True,
                is_output=False,
            )
    ...
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict[
                    "a93d681a-7e41-4a1e-b154-e746dd53680c"
                ],
                initial_setup=True,
                is_output=False,
            )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="download_status",
                node_name=node1_name,
                value=top_level_unique_values_dict[
                    "c401006c-135b-48c2-bd10-347d1ec9959d"
                ],
                initial_setup=True,
                is_output=True,
            )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict[
                    "d783b604-ea6c-4c19-870b-d16e577411a8"
                ],
                initial_setup=True,
                is_output=True,
            )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="model_card_text",
                node_name=node1_name,
                value=top_level_unique_values_dict[
                    "9971e94f-5175-4377-9a59-151732a2acaa"
                ],
                initial_setup=True,
                is_output=True,
            )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="model_card_metadata",
                node_name=node1_name,
                value=top_level_unique_values_dict[
                    "f71ad719-d7c7-4255-b088-b94844651e8f"
                ],
                initial_setup=True,
                is_output=True,
            )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict[
                    "ec14ae84-d1df-4f5d-b5af-5ca46ebf4af8"
                ],
                initial_setup=True,
                is_output=True,
            )
