...
class NIMContainerManager(ControlNode):
    def __init__(self, **kwargs):
        ...
        # Inputs / properties
        self.add_parameter(Parameter(name="action", type="str", default_value="start", allowed_modes={ParameterMode.PROPERTY}, traits={Options(choices=["start","stop","status","restart","remove"])}, tooltip="Container lifecycle action."))
