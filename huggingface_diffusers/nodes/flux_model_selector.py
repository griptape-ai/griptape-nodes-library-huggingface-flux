...
class FluxModelSelectorNode(ControlNode):
    ...
    def __init__(self, **kwargs):
        ...
        transformer_choices, clip_choices, t5_choices, model_mappings = self._discover_choices()
        ...
        self._logger.warning(f"Selector init: transformers={len(transformer_choices)}, clip={len(clip_choices)}, t5={len(t5_choices)}")
    ...
    def _discover_choices(self) -> tuple[List[str], List[str], List[str], Dict[str, str]]:
