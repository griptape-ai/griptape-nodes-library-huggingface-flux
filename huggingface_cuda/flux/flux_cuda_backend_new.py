...
class DiffusersFluxBackend(FluxBackend):
    ...
    def __init__(self):
        ...
        self._memory_manager = FluxMemoryManager(self._shared_backend)
        self._pipeline_loader = FluxPipelineLoader(self._shared_backend, self._memory_manager)
        self._generation_engine = FluxGenerationEngine(self._shared_backend, self._memory_manager, self._pipeline_loader)
    ...
    def generate_image(self, **kwargs):
        """Generate image using the generation engine"""
        return self._generation_engine.generate_image(**kwargs)